          ...
          <div className="max-w-7xl mx-auto px-4 text-sm text-slate-500 dark:text-slate-400 flex flex-col items-center justify-center gap-1">
            <div className="flex flex-wrap justify-center items-center gap-x-3 gap-y-1">
               ...
               <span className="flex items-center gap-1">
                  {t.developedBy} <a href="https://magedalhilali.github.io/Portfolio/" target="_blank" rel="noopener noreferrer" className="font-bold hover:underline transition-colors text-indigo-600 dark:text-indigo-400">{t.developerName}</a> </span>
          </div>
        </footer>
      </div>
    </div>
